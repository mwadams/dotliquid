namespace DotLiquid.Tests
{
    ...
    public class StandardFilterTests
    {
        ...
        public async Task TestCurrencyWithinTemplateRender()
        {
            ...
            var dollarTemplate = Template.Parse(@"{{ amount | currency }}");
            var euroTemplate = Template.Parse(@"{{ amount | currency: ""de-DE"" }}");
        ...
        public async Task TestDate()
        {
            ...
            var template = Template.Parse(@"{{ hi | date:""MMMM"" }}");
        ...
        public async Task TestStrFTime()
        {
            ...
            var template = Template.Parse(@"{{ hi | date:""%M"" }}");
            Assert.AreEqual("hi", await template.RenderAsync(Hash.FromAnonymousObject(new { hi = "hi" })));
        }
        ...
        {
            var assigns = Hash.FromAnonymousObject(new { a = "bc", b = "d" });
        ...
        {
            var assigns = Hash.FromAnonymousObject(new { a = "bc", b = "a" });
        ...
        public async Task TestInt32DividedByInt64()
        {
            ...
            var assigns = Hash.FromAnonymousObject(new { a, b });
        ...
        {
            var assigns = Hash.FromAnonymousObject(new { var1 = "foo", var2 = "bar" });
