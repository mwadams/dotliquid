namespace DotLiquid.Tests
{
    ...
    public class ExceptionHandlingTests
    {
        ...
        public void TestInterruptException()
        {
            ...
            InterruptException exception = Assert.Throws<InterruptException>(() => template.RenderAsync(localVariables).GetAwaiter().GetResult());
        ...
        public void TestErrorsOutputModeRethrow()
        {
            ...
            var assigns = new Hash((h, k) => { throw new SyntaxException("Unknown variable '" + k + "'"); });

            Assert.Throws<SyntaxException>(() =>
            {
                string output = template.RenderAsync(new RenderParameters(CultureInfo.InvariantCulture)
                {
        ...
        public async Task TestErrorsOutputModeSuppress()
        {
            ...
            string output = await template.RenderAsync(new RenderParameters(CultureInfo.InvariantCulture)
            {
                LocalVariables = assigns,
