namespace DotLiquid.Tests
{
    ...
    public class BlockTests
    {
        ...
        {
            var template = Template.Parse("{{funk}}  ");
        ...
        {
            var template = Template.Parse("  {{funk}} {{so}} {{brother}} ");
        ...
        {
            var template = Template.Parse("  {% comment %} {% endcomment %} ");
            Assert.AreEqual(3, template.Root.NodeList.Count);
            ExtendedCollectionAssert.AllItemsAreInstancesOfTypes(template.Root.NodeList,
        ...
        {
            Template.RegisterTag<DotLiquid.Block>("testtag");
