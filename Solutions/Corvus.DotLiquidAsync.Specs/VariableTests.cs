namespace DotLiquid.Tests
{
    ...
    public class VariableTests
    {
        ...
        {
            var var = new Variable("hello | textileze");
            Assert.AreEqual("hello", var.Name);
        ...
        {
            var var = new Variable(" '2006-06-06' | date: \"%m/%d/%Y\"");
        ...
        {
            var var = new Variable("hello | textileze | paragraph");
            Assert.AreEqual("hello", var.Name);
            AssertFiltersAreEqual(new[] { new Variable.Filter("textileze", new string[] { }), new Variable.Filter("paragraph", new string[] { }) }, var.Filters);
        ...
        {
            var var = new Variable("http://disney.com/logo.gif | image: 'med' ");
        ...
        {
            var var = new Variable(" 'hello! $!@.;\"ddasd\" ' ");
        ...
        {
            var var = new Variable(" test.test ");
