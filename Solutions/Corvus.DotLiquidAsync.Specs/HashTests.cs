...
namespace DotLiquid.Tests
{
    ...
    public class HashTests
    {
        ...
        {
            string TestClassPropValue = "TestClassPropValueValue";
            string TestBaseClassPropValue = "TestBaseClassPropValue";
        ...
        {
            this.IncludeBaseClassPropertiesOrNot(includeBaseClassProperties: false);
        }
        ...
        {
            this.IncludeBaseClassPropertiesOrNot(includeBaseClassProperties: true);
        }
        ...
        public void TestUpperTwoScenarioWithSameClass()
        {
            ...
            this.IncludeBaseClassPropertiesOrNot(false);
            this.IncludeBaseClassPropertiesOrNot(true);
        }
        #endregion
    }
}
