namespace DotLiquid.Tests
{
    ...
    public class DropTests
    {
        ...
        internal class ContextDrop : Drop
        {
            public int Scopes
            {
                get { return this.Context.Scopes.Count; }
            }

            public IEnumerable<int> ScopesAsArray
            {
                get { return Enumerable.Range(1, this.Context.Scopes.Count); }
            }

            public int LoopPos
            {
                get { return (int)this.Context["forloop.index"]; }
            }
        ...
        internal class DataRowDrop : Drop
        {
            ...
            public override object BeforeMethod(string method)
            {
                if (this._dataRow.Table.Columns.Contains(method))
                    return this._dataRow[method];
                return null;
            }
        }
#endif
        ...
        public async Task TestRubyNamingConventionPrintsHelpfulErrorIfMissingPropertyWouldMatchCSharpNamingConvention()
        {
            ...
            var template = Template.Parse("{{ value.ProductID }}");
