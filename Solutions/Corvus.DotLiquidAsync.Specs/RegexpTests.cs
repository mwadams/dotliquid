namespace DotLiquid.Tests
{
    ...
    public class RegexpTests
    {
        ...
        {
            Assembly assembly = typeof(Template).GetTypeInfo().Assembly;
            foreach (Type parent in assembly.GetTypes())
            {
                foreach (FieldInfo t in parent.GetTypeInfo().GetFields(BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic))
                {
