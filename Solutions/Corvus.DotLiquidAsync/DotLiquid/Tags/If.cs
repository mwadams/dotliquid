...
namespace DotLiquid.Tags
{
    ...
    public class If : DotLiquid.Block
    {
        ...
        public string SyntaxHelp { get; set; } = Liquid.ResourceManager.GetString("IfTagSyntaxException");

        public string TooMuchConditionsHelp { get; set; } = Liquid.ResourceManager.GetString("IfTagTooMuchConditionsException");
        ...
        private void PushBlock(string tag, string markup)
        {
            ...
            else
            {
                ...
                {
                    throw new SyntaxException(this.SyntaxHelp);
                }
                ...
                var condition = new Condition(
                    ...
                    syntaxMatch.Groups[2].Value,
                    syntaxMatch.Groups[3].Value);
                ...
                for (int i = 1; i < expressions.Count; i += 2)
                {
                    ...
                    {
                        throw new SyntaxException(this.TooMuchConditionsHelp);
                    }

                    var newCondition = new Condition(
                        expressionMatch.Groups[1].Value,
                        expressionMatch.Groups[2].Value,
                        expressionMatch.Groups[3].Value);
            ...
            this.NodeList = block.Attach(new List<object>());
        }
    }
}
